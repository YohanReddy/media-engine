...
const API_URL = `https://media-engine-backend.vercel.app/video-generation`; // Updated FastAPI server endpoint
const CALLBACK_URL = "https://media-engine-backend.vercel.app/webhook"; // Replace with your actual webhook URL
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (
            ...
            response.data.result_video.length > 0
          ) {
            setVideoUrl(response.data.result_video[0]);
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg pt-40">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            >
              Enter your URL of image to animate:
            </label>
            <input
              id="prompt"
              type="text"
